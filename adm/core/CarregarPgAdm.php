...
class CarregarPgAdm
{
    ...
    private function pgPrivate(): void
    {
        ...
        $this->listPgPrivate = ["Dashboard", "ListUsers", "ViewUsers", "AddUsers", "EditUsers", "EditUsersPassword", "EditUsersImage", "DeleteUsers", "ViewProfile", "ViewProfile", "EditProfile", "EditProfilePassword", "EditProfileImage", "ListSitsUsers", "AddSitsUsers", "EditSitsUsers", "DeleteSitsUsers", "ListColors", "AddColors", "EditColors", "ViewColors", "DeleteColors", "ListConfEmails", "ViewConfEmails", "AddConfEmails", "EditConfEmailsPassword", "DeleteConfEmails", "ListAccessLevels", "ViewAccessLevels", "AddAccessLevels", "EditAccessLevels", "DeleteAccessLevels","OrderAccessLevels","ListSitsPages","ViewSitsPages","EditSitsPages","AddSitsPages","DeleteSitsPages","ListTypesPages","ViewTypesPages","AddTypesPages","EditTypesPages","DeleteTypesPages","OrderTypesPages","ListGroupsPages","ViewGroupsPages","AddGroupsPages","EditGroupsPages","DeleteGroupsPages","OrderGroupsPages","ListPages"];
        //var_dump($this->urlController);
