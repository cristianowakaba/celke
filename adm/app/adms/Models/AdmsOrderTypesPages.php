...
class AdmsOrderTypesPages
{
    ...
    public function orderTypesPages(int $id): void
    {
        ...
        if ($this->resultBd) {
            ...
            $_SESSION['msg'] = "<p class='alert-danger'>Erro - 0143: Tipo de página não encontrado!</p>";
            $this->result = false;
        }
    }
    ...
    private function viewPrevOrderType(): void
    {
        ...
        if ($this->resultBdPrev) {
            ...
            $_SESSION['msg'] = "<p class='alert-danger'>Erro - 0144: Tipo de página não encontrado!</p>";
            $this->result = false;
        }
    }
