...
class AdmsUploadImgRes
{
    ...
    private function createDir(): void
    {
        ...
        if (!file_exists($this->directory)) {
            $_SESSION['msg'] = "<p class='alert-danger'>Erro - 0075: Upload da imagem não realizado com sucesso. Tente novamente!</p>";
            $this->result = false;
        } else {
            $this->uploadFile();
        }
    ...
    private function uploadFile(): void
    {
        ...
        switch ($this->imageData['type']) {
            ...
            case 'image/x-png':
                ...
                break;
            default:
                $_SESSION['msg'] = "<p class='alert-danger'>Erro - 0076: Necessário selecionar imagem JPEG ou PNG!</p>";
                $this->result = false;
    ...
    private function uploadFileJpeg(): void
    {
        ...
        if (imagejpeg($this->imgResize, $this->directory . $this->name, 100)) {
            ...
            $_SESSION['msg'] = "<p class='alert-danger'>Erro - 0077: Upload da imagem não realizado com sucesso. Tente novamente!</p>";
            $this->result = false;
        }
    }
    ...
    private function uploadFilePng(): void
    {
        ...
        if (imagepng($this->imgResize, $this->directory . $this->name, 1)) {
            ...
            $_SESSION['msg'] = "<p class='alert-danger'>Erro - 0078: Upload da imagem não realizado com sucesso. Tente novamente!</p>";
            $this->result = false;
        }
    }
    /**
