...
class AdmsListColors
{
    ...
    /** @var string|null Recebe o nome da cor em hexadecimal */
    ...
    public function listColors(int $page = null):void
    {
        ...
        if($this->resultBd){
            ...
            $_SESSION['msg'] = "<p class='alert-danger'>Erro - 00101: Nenhuma corr encontrada!</p>";
            $this->result = false;
        }
    }
    ...
    public function searchColorsNameCol(): void
    {
        ...
        if ($this->resultBd) {
            ...
            $_SESSION['msg'] = "<p class='alert-danger'>Erro - 00102: Nenhuma cor encontrada!</p>";
            $this->result = false;
        }
    }
    ...
    public function searchColorsName(): void
    {
        ...
        if ($this->resultBd) {
            ...
            $_SESSION['msg'] = "<p class='alert-danger'>Erro - 00103: Nenhuma cor encontrada!</p>";
            $this->result = false;
        }
    }
    ...
    public function searchColorsCol(): void
    {
        ...
        if ($this->resultBd) {
            ...
            $_SESSION['msg'] = "<p class='alert-danger'>Erro - 00104: Nenhuma cor encontrada!</p>";
            $this->result = false;
        }
    }
