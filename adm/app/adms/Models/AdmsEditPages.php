...
class AdmsEditPages
{
    ...
    public function viewPages(int $id): void
    {
        ...
        if ($this->resultBd) {
            ...
            $_SESSION['msg'] = "<p class='alert-danger'>Erro - 0162: tipo de página não encontrada!</p>";
            $this->result = false;
        }
    }
    ...
    private function edit(): void
    {
        ...
        if ($upUser->getResult()) {
            ...
            $_SESSION['msg'] = "<p class='alert-danger'>Erro - 0163: Usuário não editado com sucesso!</p>";
            $this->result = false;
        }
    }
        /**
