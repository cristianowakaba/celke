        ...
        <form method="POST" action="" id="form-edit-types-pages" class="form-adm">
            ...
            <div class="row-input">
                <div class="column">
                    ...
                    ?>
                    <label class="title-input">Tipo Do Pacote:<span class="text-danger">*</span></label>
                ...
                <div class="column">
                    ...
                    <input type="text" name="name" id="name" class="input-adm" placeholder="Digite o nome da página " value="<?php echo $name; ?>" required>
                </div>
                <div class="column">
                <?php
                        $obs = "";
