...
<div class="wrapper">
    <div class="row">
        <div class="top-list">
            <span class="title-content">Cadastrar Grupos de Página</span>
            ...
            <form method="POST" action="" id="form-add-groups-pages" class="form-adm">
                <div class="row-input">
                    <div class="column">
                        ...
                        <input type="text" name="name" id="name" class="input-adm" placeholder="Digite o nome do grupo de páginas" value="<?php echo $name; ?>" required>
                    </div>
                </div>
