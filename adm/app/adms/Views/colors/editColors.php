...
echo "<a href='" . URLADM . "list-colors/index'>Listar Cor</a><br>";
...
<form method="POST" action="" id="form-add-color">
    ...
    <input type="text" name="name" id="name" placeholder="Digite o nome da Cor" value="<?php echo $name; ?>"required ><br><br>
    <?php 
     $color= "";
  ...
  <input type="text" name="color" id="color" placeholder="Cor em hexadecimal" value="<?php echo $color; ?>"required></input><br><br>
