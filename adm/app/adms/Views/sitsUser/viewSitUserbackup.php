...
if(!defined('C8L6K7E')){
 ...
 echo "<h2>Detalhes das Situações</h2>";
 ...
 if(!empty($this->data['viewSitUser'])){
    ...
    echo "<a href='" . URLADM . "delete-sits-users/index/" . $this->data['viewSitUser'][0]['id'] . "'onclick= 'return confirm(\"Tem certeza que deseja excluir este registro?\")'>Apagar</a><br><br>";
