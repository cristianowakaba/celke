...
class EditUsersImage
{
    ...
    private function editUserImage(): void
    {
        ...
        if (!empty($this->dataForm['SendEditUseImage'])) {
            unset($this->dataForm['SendEditUseImage']);
           /*  $_FILES['new_image']? $_FILES['new_image']: operador ternario esse simbolo faz parte ?:  se for true ?  utiliza a própria imagem, se for false : atribui nulo    */
