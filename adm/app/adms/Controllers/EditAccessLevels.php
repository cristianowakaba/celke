...
class EditAccessLevels
{
     ...
     * 
     * Se nao existir o usuario clicar no botao acessa o ELSE e instancia o metodo "editAccessLevels".
     * 
     * @return void
     */
    ...
    private function viewEditAccessLevels(): void
    {
        ...
        $loadView = new \Core\ConfigView("adms/Views/accessLevels/editAccessLevels", 
        $this->data);
        $loadView->loadView();
    }
    /**
